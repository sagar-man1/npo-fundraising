...
export default async function Home() {
  ...
  const prospectRows: ProspectRow[] = prospects.map((prospect) => ({
    ...
    contactDetails: prospect.contactDetails,
    pitchAngle: prospect.pitchAngle,
    routeIn: prospect.routeIn,
    boardConnection: prospect.boardConnection,
    csrBudget: prospect.csrBudget,
    priority: prospect.priority,
    lastTouch: prospect.lastTouch?.toISOString() ?? null,
    flag: prospect.flag,
